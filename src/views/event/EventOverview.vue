    ...
    <div class="eo-kpi-row">
      ...
      <div class="eo-kpi">
        <div class="eo-kpi-top">
          ...
          <div class="eo-kpi-ic" style="background:rgba(184,146,77,0.08);color:#C9A84C">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
          </div>
        </div>
        <div class="eo-kpi-num eo-kpi-num--sm">{{ formatMoney(stats.totalContributions) }}</div>
        <div class="eo-kpi-bar-track">
          <div class="eo-kpi-bar-fill" style="background:#C9A84C" :style="{ width: progressPct + '%' }" />
        </div>
...
const quickActions = computed(() => [
  ...
  { label: 'Payments',   desc: 'Contributions & finances', to: `/event/${id.value}/payments`,  bg: 'rgba(184,146,77,0.08)', icon: `<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>` },
