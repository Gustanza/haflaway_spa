  ...
  <div class="ir-page">
    ...
    <div v-else class="ir-body">
      <header class="ir-header">
        ...
        <h1>Wageni ambao hawajapokea mwaliko wao</h1>
...
const notDeliveredAll = computed(() =>
  attendees.value.filter(a => getKardType(a) === 'invitation' && isNotDelivered(a))
)
...
const visibleList = computed(() => {
  ...
  if (!q) return reportList.value
  const qDigits = q.replace(/\D/g, '')
  return reportList.value.filter(a =>
